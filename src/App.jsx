...
function App() {
  ...
  const [weather,setWeather]=useState([])
    ...
    fetch(`${url}?key=${api_key}&q=hyderabad,visakhapatnam,vijayawada,anakapalle,tuni,bangalore,chennai,tamilnadu`)
    ...
    <>
      <div className='main'>
        <div className='child1'>
          ...
          value={city}
          type='text'
          placeholder=' Prasad Enter your city name...'
      ...
      <div className='child2'>
        ...
        <h1 id="tempc">{weather.current.temp_c}℃</h1>
        ...
        <div className='child3'>
          ...
          <h1>max:{weather.forecast.forecastday[0].day.maxtemp_c}℃</h1>
          <h1>min:{weather.forecast.forecastday[0].day.mintemp_c}℃</h1>
